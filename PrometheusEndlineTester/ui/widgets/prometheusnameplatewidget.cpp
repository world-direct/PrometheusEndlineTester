...
namespace worlddirect {
  ...
  PrometheusNamePlateWidget::PrometheusNamePlateWidget(QWidget *parent)
  ...
  void PrometheusNamePlateWidget::setType(const QString &type)
  {
    m_typeIndicator->setText(type);
  }

  void PrometheusNamePlateWidget::setHardwareVersion(const QString &hwVer)
  {
    m_hwVerIndicator->setText(hwVer);
  }

  void PrometheusNamePlateWidget::setEndpointName(const QString &ep)
  {
    m_endpointIndicator->setText(ep);
    m_qrCode->setQRData(ep);
  }

  void PrometheusNamePlateWidget::setIccId(const QString &icc)
  {
    m_iccIndicator->setText(icc);
  }

  void PrometheusNamePlateWidget::printNameplate()
  {
